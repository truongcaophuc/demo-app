...
# Tạo đường dẫn tuyệt đối tới file scaler_cluster.pkl
base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
scaler_path = os.path.join(base_dir, "resource", "scaler_cluster.pkl")
kmeans_path = os.path.join(base_dir, "resource", "kmeans_perfCluster.pkl")
...
scaler_cluster = joblib.load(scaler_path)
kmeans_cluster = joblib.load(kmeans_path)
